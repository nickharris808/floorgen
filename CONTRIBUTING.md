# Contributing to floorgen

## The one rule

**floorgen measures. It never grants.**
...
Adding a domain to `src/floorgen/domains.py` means adding *both* a safe arrangement and a foil
...
- Python 3.9+.
- Don't claim floorgen infers wait-for graphs from source. It does not, and saying so in docs is
